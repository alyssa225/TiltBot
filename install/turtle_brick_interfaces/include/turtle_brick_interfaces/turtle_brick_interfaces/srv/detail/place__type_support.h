...
#ifndef TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__TYPE_SUPPORT_H_
#define TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__TYPE_SUPPORT_H_
...
#endif  // TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__TYPE_SUPPORT_H_
