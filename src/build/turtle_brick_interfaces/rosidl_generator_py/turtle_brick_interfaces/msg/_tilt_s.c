...
bool turtle_brick_interfaces__msg__tilt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
{
  /* NOTE(esteve): Call constructor of Tilt */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_brick_interfaces.msg._tilt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tilt");
