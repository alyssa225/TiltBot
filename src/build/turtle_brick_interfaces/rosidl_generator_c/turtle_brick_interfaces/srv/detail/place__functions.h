...
#ifndef TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
#define TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
 ...
 * calls
 * turtle_brick_interfaces__srv__Place_Request__init().
...
/**
 * It calls
 * turtle_brick_interfaces__srv__Place_Request__fini()
...
/**
 * It calls
 * turtle_brick_interfaces__srv__Place_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtle_brick_interfaces__srv__Place_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_brick_interfaces
...
/**
 * It calls
 * turtle_brick_interfaces__srv__Place_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_brick_interfaces
...
/**
 * It calls
 * turtle_brick_interfaces__srv__Place_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLE_BRICK_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
