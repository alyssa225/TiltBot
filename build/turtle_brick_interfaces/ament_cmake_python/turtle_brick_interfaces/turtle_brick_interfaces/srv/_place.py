...
class Metaclass_Place(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_brick_interfaces.srv.Place')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_brick_interfaces.srv import _place
...
class Place(metaclass=Metaclass_Place):
    from turtle_brick_interfaces.srv._place import Place_Request as Request
    from turtle_brick_interfaces.srv._place import Place_Response as Response
